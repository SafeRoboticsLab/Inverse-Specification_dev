...
parser.add_argument(
    "-p", "--problem_type", help="problem type", default='series', type=str,
...
figProFolder = os.path.join(fig_folder, 'progress')
...
fig.tight_layout()
fig.savefig(os.path.join(fig_folder, 'objPairwise.png'))
